========================================================================
    APLICACIÓN DE CONSOLA: CINE DEL PAIS 
                           Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CINE DEL PAIS.

Este archivo incluye un resumen acerca del contenido de los archivos que 
constituyen su aplicación CINE DEL PAIS.


CINE DEL PAIS.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) denominado CINE DEL PAIS.pch y un archivo de tipos 
